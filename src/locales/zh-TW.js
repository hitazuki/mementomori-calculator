export default {
  ...
  tornadoTitle: '🌪 邊際收益分析',
  tornadoDesc: '橫向對比各項屬性增量（或減量）對最終傷害產生的百分比影響，尋找性價比最高的升級方案。',
  tabTornado: '🌪 龍捲風圖',
  tabWaterfall: '🌊 瀑布圖',
  baseState: '⚙ 基礎面板',
  ...
  tornadoInstDesc: '龍捲風圖用於**橫向對比互斥的升級方案**。系統會分別將左側各項「增量」**單獨**疊加到基礎面板上計算收益。<br/>排在最上方且高亮為金黃色的柱子，代表在當前環境下面板收益率（提升百分比）最高的最優解。',
  waterfallInstTitle: '💡 瀑布圖說明',
  waterfallInstDesc: '瀑布圖展示了在**基礎面板疊加左側增量**後，傷害是如何一步步被放大的。<br/>綠色柱代表乘區收益，紅色柱代表傷害丟失。透過紅色柱的高度，您可以直觀判斷哪一條防禦路吃掉了最多的傷害。',
