export default {
  ...
  packBadgeUltra: "限時",
  packBadgeMixed: "混合",
  origin_witch_first_four_elements: "魔女贈禮(首次-四屬) - 階段{stage}",
  origin_witch_first_light_dark: "魔女贈禮(首次-光暗) - 階段{stage}",
  origin_witch_rerun_four_elements: "魔女贈禮(復刻-四屬) - 階段{stage}",
  origin_witch_rerun_light_dark: "魔女贈禮(復刻-光暗) - 階段{stage}",
  ...
  origin_group_all_towers: "全塔(無窮+四屬)",
