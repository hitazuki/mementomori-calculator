export default {
  ...
  planTopUpNote: "跨日前 gap <= 累計付費鑽 × {threshold}% 時自動補包。補包不計入主預算約束。",
  planLaneSource: "觸發源",
  planLaneCurrent: "當前層/等級",
  planLaneTarget: "計畫推到",
  planLaneLimit: "2小時內最多觸發",
  planNote1: "當前層/等級表示已經達到的位置；計畫推到表示本次規劃最多推進到哪裡；2小時內最多觸發用於模擬卡包。預算單位為日元。全屬性塔抵達由藍塔、紅塔、翠塔、黃塔四行自動推算。",
  ...
  planEmptyInit: "調整預算與觸發源後，點擊「計算購買方案」。",

  // Plan Options
  planOptBest: "價值最優",
  planOptBestDesc: "在主預算和補累充浮動預算內最大化總評分價值。",
  planOptSmall: "只買小包",
  planOptSmallDesc: "只在最低檔購買，升檔後等待掉回最低檔。",
  planOptMax: "衝最大包",
  planOptMaxDesc: "優先把有限觸發機會用於更高檔禮包，必要時等待降檔。",
  planTierDiamond: "{n}鑽",
