export default {
  ...
  packResultCount: "총 {n}개의 패키지",
  packColTrigger: "층/랭크",
  packColPrice: "가격",
  packColValue: "가치",
  packColItems: "내용물",

  origin_witch_first_four_elements: "마녀의 선물 (첫회-4속성) - {stage}장",
  origin_witch_first_light_dark: "마녀의 선물 (첫회-천명) - {stage}장",
  origin_witch_rerun_four_elements: "마녀의 선물 (복각-4속성) - {stage}장",
  origin_witch_rerun_light_dark: "마녀의 선물 (복각-천명) - {stage}장",
  ...
  origin_group_all_towers: "모든 탑 (무궁+4속성)",
