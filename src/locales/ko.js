export default {
  ...
  planTopUpNote: "날짜 변경 전 gap <= 누적 유료 다이아 × {threshold}% 시 자동 충전. 충전 비용은 예산에 포함되지 않음.",
  planLaneSource: "트리거",
  planLaneCurrent: "현재 층/레벨",
  planLaneTarget: "목표",
  planLaneLimit: "2시간 내 최대",
  planNote1: "현재 레벨은 현재 도달 위치, 목표는 어디까지 밀 것인지. 2시간 내 최대는 진행 막힘 시뮬레이션용. 예산 단위는 엔. 전속성 탑은 청, 적, 취, 황탑을 통해 자동 계산됨.",
  ...
  planEmptyInit: "예산과 트리거를 조정하고 '플랜 계산'을 클릭하세요.",

  // Plan Options
  planOptBest: "가성비 최적",
  planOptBestDesc: "메인 예산 및 충전 유동 예산 내에서 총 평가 가치를 최대화합니다.",
  planOptSmall: "소형 패키지만",
  planOptSmallDesc: "최하위 티어에서만 구매하며, 티어 상승 후 다시 떨어질 때까지 대기합니다.",
  planOptMax: "대형 패키지 우선",
  planOptMaxDesc: "제한된 발생 기회를 상위 티어 패키지에 우선적으로 사용하며, 필요 시 티어 하락을 기다립니다.",
