export default {
  ...
  planTopUpNote: "Auto top-up when gap <= Total Paid Diamonds × {threshold}% before reset. Cost not counted in budget.",
  planLaneSource: "Trigger Source",
  planLaneCurrent: "Current Level",
  planLaneTarget: "Target Level",
  planLaneLimit: "Max in 2 Hours",
  planNote1: "Current Level is where you are; Target Level is where to push; Max in 2 Hours is for simulating stuck progress. Budget is in JPY. 'All Towers' is auto-derived from Blue, Red, Green, Yellow.",
  ...
  planEmptyInit: "Adjust budget and progress, then click 'Calculate Plan'.",

  // Plan Options
  planOptBest: "Best Value",
  planOptBestDesc: "Maximize total score value within main budget and top-up float.",
  planOptSmall: "Small Packs Only",
  planOptSmallDesc: "Only buy at lowest tier, wait to drop back after tier up.",
  planOptMax: "Max Tier Packs",
  planOptMaxDesc: "Prioritize higher tier packs, wait for tier drop if necessary.",
