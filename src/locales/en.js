export default {
  ...
  origin_witch_first_four_elements: "Witch's Gift (First-4Elem) - Stage {stage}",
  origin_witch_first_light_dark: "Witch's Gift (First-L/D) - Stage {stage}",
  origin_witch_rerun_four_elements: "Witch's Gift (Rerun-4Elem) - Stage {stage}",
  origin_witch_rerun_light_dark: "Witch's Gift (Rerun-L/D) - Stage {stage}",
  ...
  origin_group_all_towers: "All Towers (Inf+4Elem)",
