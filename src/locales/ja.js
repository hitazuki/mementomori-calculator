export default {
  ...
  appDesc:
    "メメントモリ 多次元ダメージ計算＆可視化：貫通スキャン、ヒートマップ、構成比較、テーブル出力",
  appName: "メメントモリ",
  appSub: "各種計算機",
  ...
  origin_witch_first_four_elements: "魔女の贈り物 (初回-4属性) - 第{stage}章",
  origin_witch_first_light_dark: "魔女の贈り物 (初回-天冥) - 第{stage}章",
  origin_witch_rerun_four_elements: "魔女の贈り物 (復刻-4属性) - 第{stage}章",
  origin_witch_rerun_light_dark: "魔女の贈り物 (復刻-天冥) - 第{stage}章",
  ...
  origin_group_all_towers: "全ての塔 (無窮+4属性)",
