export default {
  ...
  planTopUpNote: "日付変更前のgap <= 累計有償ダイヤ × {threshold}% で自動チャージ。チャージ費用は予算に含めません。",
  planLaneSource: "トリガー源",
  planLaneCurrent: "現在の階層/レベル",
  planLaneTarget: "目標",
  planLaneLimit: "2時間内最大",
  planNote1: "現在レベルは現在の進行度、目標はどこまで進めるか。2時間内最大は進行停止のシミュレート用。予算単位は円。全属性塔は青、赤、緑、黄塔から自動算出されます。",
  ...
  planEmptyInit: "予算とトリガー源を調整し、「プランを計算」をクリックしてください。",

  // Plan Options
  planOptBest: "価値最適",
  planOptBestDesc: "主予算とチャージ変動予算内で合計評価価値を最大化します。",
  planOptSmall: "小パックのみ",
  planOptSmallDesc: "最低ティアでのみ購入し、ティア上昇後は元に戻るのを待ちます。",
  planOptMax: "最大パック優先",
  planOptMaxDesc: "限られたトリガー機会を上位ティアのパックに優先して使用し、必要に応じてティア低下を待ちます。",
