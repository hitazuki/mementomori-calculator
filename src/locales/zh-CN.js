export default {
  ...
  tornadoTitle: '🌪 边际收益分析',
  tornadoDesc: '横向对比各项属性增量（或减量）对最终伤害产生的百分比影响，寻找性价比最高的升级方案。',
  tabTornado: '🌪 龙卷风图',
  tabWaterfall: '🌊 瀑布图',
  baseState: '⚙ 基础面板',
  ...
  tornadoInstDesc: '龙卷风图用于**横向对比互斥的升级方案**。系统会分别将左侧各项“增量”**单独**叠加到基础面板上计算收益。<br/>排在最上方且高亮为金黄色的柱子，代表在当前环境下面板收益率（提升百分比）最高的最优解。',
  waterfallInstTitle: '💡 瀑布图说明',
  waterfallInstDesc: '瀑布图展示了在**基础面板叠加左侧增量**后，伤害是如何一步步被放大的。<br/>绿色柱代表乘区收益，红色柱代表伤害丢失。通过红色柱的高度，您可以直观判断哪一条防御路吃掉了最多的伤害。',
