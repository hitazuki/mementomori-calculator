export default {
  ...
  // Battle Parameters & Attributes
  'appBasicStr': '力量',
  'appBasicDex': '灵巧',
  'appBasicMag': '魔力',
  'appBasicStm': '耐力',
  '[BattleParameterTypeAttackPower]': '攻击力',
  '[BattleParameterTypeHp]': '最大HP',
  '[BattleParameterTypeDefense]': '防御力',
  '[BattleParameterTypePhysicalDamageRelax]': '物理防御力',
  '[BattleParameterTypeMagicDamageRelax]': '魔法防御力',
  '[BattleParameterTypeDefensePenetration]': '防御贯通',
  '[BattleParameterTypeDamageEnhance]': '伤害增加',
  '[BattleParameterTypeCritical]': '暴击',
  '[BattleParameterTypeCriticalDamageEnhance]': '暴击伤害强化',
  '[BattleParameterTypeCriticalResist]': '暴击抵抗',
  '[BattleParameterTypePhysicalCriticalDamageRelax]': '物理暴击伤害缓和',
  '[BattleParameterTypeMagicCriticalDamageRelax]': '魔法暴击伤害缓和',
  '[BattleParameterTypeHit]': '命中',
  '[BattleParameterTypeAvoidance]': '回避',
  '[BattleParameterTypeDebuffHit]': '弱体命中',
  '[BattleParameterTypeDebuffResist]': '弱体抵抗',
  '[BattleParameterTypeHpDrain]': 'HP吸收',
  '[BattleParameterTypeDamageReflect]': '伤害反射',
