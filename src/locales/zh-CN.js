export default {
  ...
  packCalcSource: "数据来源 tamamo.dev，内容物可能有误，注意辨别",
  packFilterTitle: "筛选",
  ...
  packBadgeUltra: "限时",
  packBadgeMixed: "混合",
  origin_witch_first_four_elements: "魔女赠礼(首次-四属) - 阶段{stage}",
  origin_witch_first_light_dark: "魔女赠礼(首次-光暗) - 阶段{stage}",
  origin_witch_rerun_four_elements: "魔女赠礼(复刻-四属) - 阶段{stage}",
  origin_witch_rerun_light_dark: "魔女赠礼(复刻-光暗) - 阶段{stage}",
