      ...
      <div class="card">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px">
          <div style="display:flex;gap:6px">
            <button class="btn btn-sm" :class="cs.chartMode==='bar'?'btn-primary':'btn-ghost'" @click="cs.chartMode='bar'">Bar</button>
            <button class="btn btn-sm" :class="cs.chartMode==='radar'?'btn-primary':'btn-ghost'" @click="cs.chartMode='radar'">Radar</button>
            <button class="btn btn-sm" :class="cs.chartMode==='table'?'btn-primary':'btn-ghost'" @click="cs.chartMode='table'">Table</button>
          </div>
